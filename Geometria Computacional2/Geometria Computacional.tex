...
\begin{frame}{Distância de um ponto para uma Reta}
\begin{columns}[T] % align columns
\begin{column}{.68\textwidth}
\begin{algorithm}[H]
\caption{Algoritmo DistânciaPontoReta}
\begin{algorithmic}[1]
\Function {DistânciaPontoReta}{$p,p0,p1$}
...
\begin{frame}[fragile]{Distância Ponto Reta}
...
\BIT
\item Linha de varredura é uma estratégia para solução de problemas geométrico.

\item A ideia geral é manter uma linha (com algumas informações auxiliares) que varre através do plano e resolve o problema localmente

\item Definimos eventos que causam a mudança da nossa estrutura de dados auxiliar.
\EIT

\end{frame}

\begin{frame}{Par de pontos mais próximos}
...
\begin{frame}{União de retângulos}

\BIT
\item Dado n retângulos alinhados com o eixo x encontre a área da união deles.

\item Nós vamos varrer o plano da esquerda para direita

\item Eventos: Aresta esquerda e aresta direita dos retângulos.

\item A ideia principal é manter um conjunto de retângulos ativos.
\EIT
...
\BIT
\item Fecho convexo
\item Encontrar o perímetro da união de retângulos
\item Encontrar todas as k intersecções entre n segmentos em $O( (n+k) ~log~ n)$
\EIT
\end{frame}

\begin{frame}{Exercício}

Calcule o volume do paralelepípedo a partir de três vetores $\overrightarrow{u}$,$\overrightarrow{u}$ e $\overrightarrow{w}$.

\begin{center}
\includegraphics[height=0.6\textheight]{paralelepipedo}
\end{center}
...
Seja $\overrightarrow{u} = (a_1,a_2,a_3)$ e $\overrightarrow{v} = (b_1,b_2,b_3)$,
\begin{equation}
\overrightarrow{u} \times \overrightarrow{v} = \left[
\begin{array}{cc}%
a_2 & a_3\\
b_2 & b_3\\
\end{array}
\right]\overrightarrow{i} + \left[
\begin{array}{cc}%
a_1 & a_3\\
b_1 & b_3\\
\end{array}
\right]\overrightarrow{j}+\left[
\begin{array}{cc}%
a_1 & a_2\\
b_1 & b_2\\
\end{array}
...
\begin{equation}
\overrightarrow{u} \times \overrightarrow{v} = a_1*b_1 + a_2*b_2 + a_3*b_3  
\end{equation}
...
\begin{center}
\includegraphics[height=0.6\textheight]{paralelepipedo2}
\end{center}
...
Calcule o volume do tetraedro a partir de três vetores $\overrightarrow{u}$,$\overrightarrow{u}$ e $\overrightarrow{w}$.

\begin{center}
\includegraphics[height=0.6\textheight]{tetraedro}
\end{center}
...
\BE
\item \url{http://www.spoj.com/problems/QCJ4/}
\item \url{http://www.spoj.com/problems/BLMIRANA/}
\item \url{http://www.spoj.com/problems/CLOPPAIR/}
\item \url{http://www.spoj.com/problems/MPOLY/}
\item \url{http://www.spoj.com/problems/CROSSPDCT/}
\item \url{http://www.spoj.com/problems/INOROUT/}
\item \url{https://www.urionlinejudge.com.br/judge/pt/problems/view/1295}
\item \url{https://www.urionlinejudge.com.br/judge/pt/problems/view/1039}
\item \url{https://www.urionlinejudge.com.br/judge/pt/problems/view/2045}
\EE
